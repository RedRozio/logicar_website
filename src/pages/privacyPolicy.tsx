...
const PrivacyPolixy = () => (
  <div className="antialiased text-gray-600">
    <Meta title={'Privacy Policy'} description={AppConfig.description} />
    <div className="header p-5">
      <div className="container">
        <p className="text-3xl text-gray-900 font-semibold">
          Privacy Policy for Logicar
        </p>
        <p>Last updated: December 30, 2022</p>
      </div>
    </div>
    <div className="translations-content-container p-5">
      <div className="container">
        <div
        ...
        >
          ...
          <p className="text-1xl font-semibold">Interpretation</p>
          <p>
          ...
          <p className="text-1xl font-semibold">Definitions</p>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Logicar, the software
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Logicar AS, Idrettssvingen 6.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>By email: support@logicar.no</li>
          </ul>
        </div>
      </div>
    </div>
